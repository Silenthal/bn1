...
int main(void)
{
    ...
    // Struct_Unk08
    DECLARE("Struct_Unk08_m_state0"                     , offsetof(Struct_Unk08, m_state0));
    DECLARE("Struct_Unk08_b1"                           , offsetof(Struct_Unk08, b1));
    DECLARE("Struct_Unk08_b2"                           , offsetof(Struct_Unk08, b2));
    DECLARE("Struct_Unk08_b3"                           , offsetof(Struct_Unk08, b3));
    DECLARE("Struct_Unk08_m_currentArea"                , offsetof(Struct_Unk08, m_currentArea));
    DECLARE("Struct_Unk08_m_currentSubArea"             , offsetof(Struct_Unk08, m_currentSubArea));
    DECLARE("Struct_Unk08_m_possibleStoryFlag"          , offsetof(Struct_Unk08, m_possibleStoryFlag));
    DECLARE("Struct_Unk08_m_b7_fadeType"                , offsetof(Struct_Unk08, m_b7_fadeType));
    DECLARE("Struct_Unk08_b8"                           , offsetof(Struct_Unk08, b8));
    DECLARE("Struct_Unk08_m_Battle_IsTimePaused"        , offsetof(Struct_Unk08, m_Battle_IsTimePaused));
    DECLARE("Struct_Unk08_m_b10"                        , offsetof(Struct_Unk08, m_b10));
    DECLARE("Struct_Unk08_m_b11_backgroundId"           , offsetof(Struct_Unk08, m_b11_backgroundId));
    DECLARE("Struct_Unk08_m_bx11"                       , offsetof(Struct_Unk08, m_bx11));
    DECLARE("Struct_Unk08_m_bx12"                       , offsetof(Struct_Unk08, m_bx12));
    DECLARE("Struct_Unk08_m_b14"                        , offsetof(Struct_Unk08, m_b14));
    DECLARE("Struct_Unk08_m_battleType"                 , offsetof(Struct_Unk08, m_battleType));
    DECLARE("Struct_Unk08_m_b16_state"                  , offsetof(Struct_Unk08, m_b16_state));
    DECLARE("Struct_Unk08_m_isShuffleFolder"            , offsetof(Struct_Unk08, m_isShuffleFolder));
    DECLARE("Struct_Unk08_m_b18_commentaryTextIndex"    , offsetof(Struct_Unk08, m_b18_commentaryTextIndex));
    DECLARE("Struct_Unk08_m_b19_fadeStep"               , offsetof(Struct_Unk08, m_b19_fadeStep));
    DECLARE("Struct_Unk08_m_b20_stat1_atk"              , offsetof(Struct_Unk08, m_b20_stat1_atk));
    DECLARE("Struct_Unk08_m_b21_stat2_spd"              , offsetof(Struct_Unk08, m_b21_stat2_spd));
    DECLARE("Struct_Unk08_m_b22_stat3_chg"              , offsetof(Struct_Unk08, m_b22_stat3_chg));
    DECLARE("Struct_Unk08_m_b23_possibleArmor"          , offsetof(Struct_Unk08, m_b23_possibleArmor));
    DECLARE("Struct_Unk08_m_Song_CurrentSongId"         , offsetof(Struct_Unk08, m_Song_CurrentSongId));
    DECLARE("Struct_Unk08_m_bustingRank"                , offsetof(Struct_Unk08, m_bustingRank));
    DECLARE("Struct_Unk08_m_b26"                        , offsetof(Struct_Unk08, m_b26));
    DECLARE("Struct_Unk08_m_b27"                        , offsetof(Struct_Unk08, m_b27));
    DECLARE("Struct_Unk08_m_u0_hp0"                     , offsetof(Struct_Unk08, m_u0_hp0));
    DECLARE("Struct_Unk08_m_u1_hp1"                     , offsetof(Struct_Unk08, m_u1_hp1));
    DECLARE("Struct_Unk08_ix0"                          , offsetof(Struct_Unk08, ix0));
    DECLARE("Struct_Unk08_m_ix1"                        , offsetof(Struct_Unk08, m_ix1));
    DECLARE("Struct_Unk08_m_i0"                         , offsetof(Struct_Unk08, m_i0));
    DECLARE("Struct_Unk08_m_enemyList"                  , offsetof(Struct_Unk08, m_enemyList));
    DECLARE("Struct_Unk08_m_chipFolder"                 , offsetof(Struct_Unk08, m_chipFolder));
    DECLARE("Struct_Unk08_m_battleInitHideObject"       , offsetof(Struct_Unk08, m_battleInitHideObject));
    DECLARE("Struct_Unk08_m_ix7_savedPosY"              , offsetof(Struct_Unk08, m_ix7_savedPosY));
    DECLARE("Struct_Unk08_m_ix8_savedPosX"              , offsetof(Struct_Unk08, m_ix8_savedPosX));
    DECLARE("Struct_Unk08_m_ix9_savedPos0"              , offsetof(Struct_Unk08, m_ix9_savedPos0));
    DECLARE("Struct_Unk08_m_ix10_savedDirection"        , offsetof(Struct_Unk08, m_ix10_savedDirection));
    DECLARE("Struct_Unk08_ix11"                         , offsetof(Struct_Unk08, ix11));
    DECLARE("Struct_Unk08_ix12"                         , offsetof(Struct_Unk08, ix12));
    DECLARE("Struct_Unk08_ix13"                         , offsetof(Struct_Unk08, ix13));
    DECLARE("Struct_Unk08_ix14"                         , offsetof(Struct_Unk08, ix14));
    DECLARE("Struct_Unk08_ix15"                         , offsetof(Struct_Unk08, ix15));
    DECLARE("Struct_Unk08_ix16"                         , offsetof(Struct_Unk08, ix16));
    DECLARE("Struct_Unk08_ix17"                         , offsetof(Struct_Unk08, ix17));
    DECLARE("Struct_Unk08_ix18"                         , offsetof(Struct_Unk08, ix18));
    DECLARE("Struct_Unk08_ix19"                         , offsetof(Struct_Unk08, ix19));
    DECLARE("Struct_Unk08_ix20"                         , offsetof(Struct_Unk08, ix20));
    DECLARE("Struct_Unk08_ix21"                         , offsetof(Struct_Unk08, ix21));
    DECLARE("Struct_Unk08_m_zenny"                      , offsetof(Struct_Unk08, m_zenny));
