...
typedef struct BattleChipSelect BattleChipSelect, *PBattleChipSelect;

typedef enum FuncState_BCS_00 {
    FS_BCS_State0=0,
    FS_BCS_State1=4,
    FS_BCS_State2=8
} FuncState_BCS_00;

typedef enum FuncState_BCS_01 {
    FS_BCSD_01_OpenChipSelect=0,
    FS_BCSD_01_State1=4,
    FS_BCSD_01_State2=8,
    FS_BCSD_01_State3=12,
    FS_BCSD_01_State4=16,
    FS_BCSD_01_State5=20,
    FS_BCSD_01_State6=24
} FuncState_BCS_01;

typedef enum FuncState_BCS_02 {
    FS_BCSD_02_ChipSelectSlide=4,
    FS_BCSD_02_InitChipSelect=0,
    FS_BCSD_02_State2=8,
    FS_BCSD_02_State3=12
} FuncState_BCS_02;

typedef enum FuncState_BCS_03 {
    FS_BCS_03_State0=0,
    FS_BCS_03_State1=1,
    FS_BCS_03_State2=2,
    FS_BCS_03_State3=3,
...
typedef struct LayoutEntry LayoutEntry, *PLayoutEntry;
...
struct BattleChipSelect {
    ...
    byte b13;
    byte b14;
    enum FuncState_BCS_01 m_priorState1;
...
typedef enum FuncState_4CD0_00 {
    FS_4CD0_00_State0=0,
    FS_4CD0_00_State1=4,
    FS_4CD0_00_State2=8
} FuncState_4CD0_00;

typedef enum FuncState_4CD0_01 {
    FS_4CD0_01_State0=0,
    FS_4CD0_01_State1=4,
    FS_4CD0_01_State2=8
} FuncState_4CD0_01;

typedef enum FuncState_4CD0_02 {
    FS_4CD0_02_State0=0,
    FS_4CD0_02_State1=4,
    FS_4CD0_02_State2=8
} FuncState_4CD0_02;

typedef enum FuncState_4CD0_03 {
    FS_4CD0_03_State0=0,
    FS_4CD0_03_State1=4,
    FS_4CD0_03_State2=8,
    FS_4CD0_03_State3=12
} FuncState_4CD0_03;

typedef enum FuncState_58 {
    FS_58_State0=0,
    FS_58_State1=4,
    FS_88_State2=8
} FuncState_58;

typedef enum FuncState_GameOver {
    FS_GO_PlayGameOverScreen=0,
    FS_GO_ResetGame=8,
    FS_GO_WaitTillGameOverEnd=4
} FuncState_GameOver;

typedef struct GameOver GameOver, *PGameOver;

struct GameOver {
    enum FuncState_GameOver m_state;
    byte _pad0[3];
...
struct Struct_Unk0C {
    enum FuncState_0C_00 m_state0;
    enum FuncState_0C_01 m_state1;
    enum FuncState_0C_02 m_state2;
    byte sx0;
    byte b4;
    byte counter0;
    byte b6;
    ...
    byte m_bitField2;
    byte m_b10;
    byte m_b11_encounterEnemyCount;
    byte m_b12;
    byte m_b13;
    byte m_b14;
    ...
    struct Struct_20066B0 * m_i9;
    struct Struct_20066B0 * q0[4];
    struct Struct_20066B0 * m_possibleEncounterEnemyFieldDetail[4];
    byte m_possibleEncounterEnemyIdList[4];
    uint u0;
    uint m_bitField00;
    uint m_bitField0;
...
struct ScreenLayoutContainer {
    struct LayoutEntry screen0[1024];
    struct LayoutEntry screen1[1024];
    struct LayoutEntry screen2[1024];
...
struct Text {
    ...
    struct LayoutEntry * m_dialogLayout;
    uint m_itemIdList[4];
...
struct Main {
    ...
    struct Struct_Unk50_TimerRelated * unk_50;
...
typedef struct Struct_4A0 Struct_4A0, *PStruct_4A0;
...
struct Struct_4CD0 {
    ...
    byte b6;
    byte b7;
    enum FuncState_4CD0_00 m_state0;
    enum FuncState_4CD0_01 m_state1;
    enum FuncState_4CD0_02 m_state2;
    enum FuncState_4CD0_03 m_state3;
    byte m_bustingRank;
    byte m_scoreRank;
    byte m_possibleRewardChipId;
    byte m_possibleRewardChipCode;
    int i3;
    int i4;
    byte b8;
    byte b9;
