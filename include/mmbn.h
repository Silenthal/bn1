...
typedef enum FullArea {
    Map_School_Class_5A=0x00,
    Map_School_Class_5B=0x01,
    Map_School_Library=0x02,
    Map_School_2F_Hallway=0x03,
    Map_School_Class_1A=0x05,
    Map_School_Class_1B=0x06,
    Map_School_AV_Room=0x07,
    Map_School_Infirmary=0x08,
    Map_School_1F_Hallway=0x0A,
    Map_School_Cross_Hallway=0x0B,
    Map_School_Storage=0x0C,
    Map_School_Staff_Lounge=0x0D,
    Map_School_Staff_Lounge_Hallway=0x0E,
    Map_ACDC_Town=0x0100,
    Map_ACDC_School_Gate=0x0101,
    Map_ACDC_Lan_Living_Room=0x0102,
    Map_ACDC_Lan_Room=0x0103,
    Map_ACDC_Mayl_Living_Room=0x0105,
    Map_ACDC_Mayl_Room=0x0106,
    Map_ACDC_Dex_Room=0x0107,
    Map_ACDC_Yai_Room=0x0109,
    Map_ACDC_Higsby=0x010B,
    Map_ACDC_Station=0x010C,
    Map_ACDC_Secret_Station=0x010D,
    Map_Govt_Complex_Front=0x0200,
    Map_Govt_Complex_Station=0x0201,
    Map_Govt_Waterworks_Lobby=0x0202,
    Map_Govt_SciLab_Lobby=0x0203,
    Map_Govt_Complex_Hallway=0x0204,
    Map_Govt_Yuichiro_Lab=0x0205,
    Map_Govt_Waterworks_Office=0x0206,
    Map_Govt_Waterworks_Control_Room=0x0207,
    Map_Govt_Waterworks_Pump_Room=0x0209,
    Map_Govt_Waterworks_Purification_Room=0x020B,
    Map_Dentown_Center=0x0300,
    Map_Dentown_Station=0x0301,
    Map_Dentown_Block_1=0x0302,
    Map_Dentown_Block_2=0x0303,
    Map_Dentown_Block_3=0x0304,
    Map_Dentown_Block_4=0x0305,
    Map_Dentown_Miyu_Antiques=0x0306,
    Map_Dentown_Summer_School=0x0307,
    Map_SciLab_Restaurant_Hallway=0x0400,
    Map_SciLab_Restaurant=0x0401,
    Map_SciLab_Power_Plant_Hallway=0x0402,
    Map_SciLab_Power_Plant=0x0403,
    Map_SciLab_Power_Plant_Control_Room=0x0404,
    Map_SciLab_Generator_Room=0x0405,
    Map_WWW_Base=0x0500,
    Map_WWW_Wily_Lab=0x0501,
    Map_WWW_Rocket_Hanger=0x0502,
    Map_WWW_Passage_1=0x0503,
    Map_WWW_Passage_2=0x0504,
    Map_WWW_Passage_3=0x0505,
    Map_School_Comp_1=0x8000,
    Map_School_Comp_2=0x8001,
    Map_School_Comp_3=0x8002,
    Map_School_Comp_4=0x8003,
    Map_School_Comp_5=0x8004,
    Map_Oven_Comp_1=0x8100,
    Map_Oven_Comp_2=0x8101,
    Map_Waterworks_Comp_1=0x8200,
    Map_Waterworks_Comp_2=0x8201,
    Map_Waterworks_Comp_3=0x8202,
    Map_Waterworks_Comp_4=0x8203,
    Map_Waterworks_Comp_5=0x8204,
    Map_Waterworks_Comp_6=0x8205,
    Map_Traffic_Light_Comp_1=0x8300,
    Map_Traffic_Light_Comp_2=0x8301,
    Map_Traffic_Light_Comp_3=0x8302,
    Map_Traffic_Light_Comp_4=0x8303,
    Map_Traffic_Light_Comp_5=0x8304,
    Map_Power_Plant_Comp_1=0x8400,
    Map_Power_Plant_Comp_2=0x8401,
    Map_Power_Plant_Comp_3=0x8402,
    Map_Power_Plant_Comp_4=0x8403,
    Map_WWW_Comp_1=0x8500,
    Map_WWW_Comp_2=0x8501,
    Map_WWW_Comp_3=0x8502,
    Map_WWW_Comp_4=0x8503,
    Map_WWW_Comp_5=0x8504,
    Map_Rocket_Comp=0x8505,
    Map_ACDCHP_Lan=0x8800,
    Map_ACDCHP_Mayl=0x8801,
    Map_ACDCHP_Yai=0x8802,
    Map_ACDCHP_Dex=0x8803,
    Map_GovtHP_Yuichiro=0x8900,
    Map_GovtHP_LunchCartComp=0x8901,
    Map_DentownHP_AntiqueComp=0x8A00,
    Map_GovtHP_FishCartComp=0x8B00,
    Map_Other_Doghouse_Comp=0x8C00,
    Map_Other_Servbot_Comp=0x8C01,
    Map_Other_New_Game_Machine_Comp=0x8C02,
    Map_Other_Telephone_Comp=0x8C03,
    Map_Other_Car_Comp=0x8C04,
    Map_Other_Vending_Machine_Waterworks=0x8C05,
    Map_Other_Lobby_TV_Comp=0x8C06,
    Map_Other_Large_Monitor_Comp=0x8C07,
    Map_Other_Control_Equipment_Comp=0x8C08,
    Map_Other_Vending_Machine_SciLab=0x8C09,
    Map_Other_Recycled_PET_Comp=0x8C0A,
    Map_Other_Big_Vase_Comp=0x8C0B,
    Map_Other_Blackboard_Comp=0x8C0C,
    Map_Internet_1=0x9000,
    Map_Internet_2=0x9001,
    Map_Internet_3=0x9002,
    Map_Internet_4=0x9003,
    Map_Undernet_1=0x9004,
    Map_Undernet_2=0x9005,
    Map_Undernet_3=0x9006,
    Map_Undernet_4=0x9007,
    Map_Undernet_5=0x9008,
    Map_Undernet_6=0x9009,
    Map_Undernet_7=0x900A,
    Map_Undernet_8=0x900B,
    Map_Undernet_9=0x900C,
    Map_Undernet_10=0x900D,
    Map_Undernet_11=0x900E,
    Map_Undernet_12=0x900F
} FullArea;
