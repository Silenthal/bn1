...
typedef enum FullArea {
    ...
    Map_School_Storage=0xC,
    Map_School_Staff_Lounge=0xD,
    Map_School_Staff_Lounge_Hallway=0xE,
    Map_ACDC_Town=0x10,
    Map_ACDC_School_Gate=0x11,
    Map_ACDC_Lan_Living_Room=0x12,
    Map_ACDC_Lan_Room=0x13,
    Map_ACDC_Mayl_Living_Room=0x15,
    Map_ACDC_Mayl_Room=0x16,
    Map_ACDC_Dex_Room=0x17,
    Map_ACDC_Yai_Room=0x19,
    Map_ACDC_Higsby=0x1B,
    Map_ACDC_Station=0x1C,
    Map_ACDC_Secret_Station=0x1D,
    Map_Govt_Complex_Front=0x20,
    Map_Govt_Complex_Station=0x21,
    Map_Govt_Waterworks_Lobby=0x22,
    Map_Govt_SciLab_Lobby=0x23,
    Map_Govt_Complex_Hallway=0x24,
    Map_Govt_Yuichiro_Lab=0x25,
    Map_Govt_Waterworks_Office=0x26,
    Map_Govt_Waterworks_Control_Room=0x27,
    Map_Govt_Waterworks_Pump_Room=0x29,
    Map_Govt_Waterworks_Purification_Room=0x2B,
    Map_Dentown_Center=0x30,
    Map_Dentown_Station=0x31,
    Map_Dentown_Block_1=0x32,
    Map_Dentown_Block_2=0x33,
    Map_Dentown_Block_3=0x34,
    Map_Dentown_Block_4=0x35,
    Map_Dentown_Miyu_Antiques=0x36,
    Map_Dentown_Summer_School=0x37,
    Map_SciLab_Restaurant_Hallway=0x40,
    Map_SciLab_Restaurant=0x41,
    Map_SciLab_Power_Plant_Hallway=0x42,
    Map_SciLab_Power_Plant=0x43,
    Map_SciLab_Power_Plant_Control_Room=0x44,
    Map_SciLab_Generator_Room=0x45,
    Map_WWW_Base=0x50,
    Map_WWW_Wily_Lab=0x51,
    Map_WWW_Rocket_Hanger=0x52,
    Map_WWW_Passage_1=0x53,
    Map_WWW_Passage_2=0x54,
    Map_WWW_Passage_3=0x55,
